...
if __name__ == "__main__":
 ...
 #              'signal'         : 'results/nonReweited/signal_hhhTo4b2g.root',
        ...
        for cands in candDict:
            ...
            plot.xTitle = "m_{4b3#gamms} [GeV]"
            plot.xRange = (400,1500.0) 
            plot.yRange = (0.9,5000.0) 
            ...
            for ky in ['ttX','ggJetsM80','gJets']:
                hist=histStore[ky][cands]['hhh']['mass'].Clone()
            ...
            dataHist=histStore['data2018'][cands]['hhh']['mass'].Clone()
            ...
            #canvas.SetLogy()
            #canvas.Draw()
            oFname=pltPrefix+'/mhhh_ratio.png'
            if preReweight:
                oFname=pltPrefix+'/mhhh_preReweighting_ratio.png'
