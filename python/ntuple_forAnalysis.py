...
nonResonantMVA=tmva.TMVAModel()
nonResonantMVA.setupTMVAModel("hhhVsNR", MVAWeightFile , MVABranches , MVASpecBranches )
...
branches=[
     ...
     'HH4bCosThetaLeadJet','leadingPhotonSigOverE', 'pT_4b', 
     'pTh1leadJ_overMh1','pTh1subleadJ_overMh1', 'pTh2leadJ_overMh2', 'pTh2subleadJ_overMh2',
     ...
     'diphoton_pt','diphoton_eta','diphoton_phi','nonResonantMVA_v0',
     'weight_v0', 'weight','scale_factor','lumi_weight','lumi','year','dataTag','sample'
]
...
for fname in allFnames:
    ...
    for i in range(maxEvents_):
     ...
     #'diphoton_pt','diphoton_eta','diphoton_phi','weight_v0', 'weight','scale_factor','lumi_weight','lumi','year','dataTag','nonResonantMVA_v0'
