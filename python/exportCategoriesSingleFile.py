...
def main():
    exportBranches=[
        ...
        'quadjet_2_flavour',
        'quadjet_3_flavour',
        'mva_vsNonResonantBDT_v24p0_1',
        'mva_vsPeakingBDT_vsTTH_v34p0_1'
    ]
    ...
    if (syst=='nominal') or ('JEC' in syst):
        exportBranches+=btagBranches
        print("Adding the Btag Branches !")
    else:
        print("SKIPPING BTAG BRNCHES for syst ",syst)
    ...
    try :
        ...
        try :
            ...
            rdataFrames[year][tag][proc]= ROOT.RDataFrame(treeName, fileName)    
            dd = rdataFrames[year][tag][proc].GetColumnNames()
    print("Exporting : ",exportBranches)
