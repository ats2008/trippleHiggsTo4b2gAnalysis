...
if __name__ == "__main__":
    ...
    for preReweight in [False]:
        ...
        for cands in candDict:
            ...
            plot.xTitle = "MVA Score"
            plot.xRange = (-1.10,1.10) 
            plot.yRange = (0.9,2000.0) 
            ...
            for ky in ['ttX','ggJetsM80','gJets']:
                hist=histStore[ky]['cat0_mvaNR_v0'].Clone()
            ...
            dataHist=histStore['data2018']['cat0_mvaNR_v0'].Clone()
            ...
            #canvas.SetLogy()
            #canvas.Draw()
            oFname=pltPrefix+'/cat0_mvaNR_v0.png'
            if preReweight:
                oFname=pltPrefix+'/cat0_mvaNR_v0_preReweighting_ratio.png'
