...
def main():
    ...
    varsToGet+=[
            ...
            'quadjet_2_isPULoose',
            'quadjet_3_isPULoose',
            'quadjet_0_isPUMedium',
            'quadjet_1_isPUMedium',
            'quadjet_2_isPUMedium',
            'quadjet_3_isPUMedium',
            'quadjet_0_isPUTight',
            'quadjet_1_isPUTight',
            'quadjet_2_isPUTight',
            'quadjet_3_isPUTight',
    ...
    for yr in yearsToProcess:
        saveBase=prefixBase+'/'+yr+'/puJetId/'
        ...
        for dset in ['bkg','data','sig']:
            ...
            for ky in rdataFrames[yr][dset]:
                ...
                idMap={'b1':{},'b2':{},'b3':{},'b4':{}}
                idMap['b1']['T'] = varData['quadjet_0_isPUTight'] >0.2
                idMap['b2']['T'] = varData['quadjet_1_isPUTight'] >0.2
                idMap['b3']['T'] = varData['quadjet_2_isPUTight'] >0.2
                idMap['b4']['T'] = varData['quadjet_3_isPUTight'] >0.2
                idMap['b1']['M'] = varData['quadjet_0_isPUMedium'] >0.2
                idMap['b2']['M'] = varData['quadjet_1_isPUMedium'] >0.2
                idMap['b3']['M'] = varData['quadjet_2_isPUMedium'] >0.2
                idMap['b4']['M'] = varData['quadjet_3_isPUMedium'] >0.2
                idMap['b1']['L'] = varData['quadjet_0_isPULoose'] >0.2
                idMap['b2']['L'] = varData['quadjet_1_isPULoose'] >0.2
                idMap['b3']['L'] = varData['quadjet_2_isPULoose'] >0.2
                idMap['b4']['L'] = varData['quadjet_3_isPULoose'] >0.2
                vals=[]
                ...
                ax2.set_yticks([])
                f.savefig(saveBase+'/puSelectionEffciency_'+dset+'.png',bbox_inches='tight')
                ...
                plt.colorbar(c,cax=ax2)
                ax2.set_yticks([])
                f.savefig(saveBase+'/puSelectionCount_'+dset+'.png',bbox_inches='tight')
            print(tabYieldData)
        ...
        for i,dset in enumerate(['data','bkg']):
            ax=axSet[i]
            significance = scoreMaps['sig']/np.sqrt(scoreMaps['sig'] + scoreMaps[dset] )
            print(dset,significance)
            ...
            ax2.set_yticks([])
            print(tabYieldData)
        f.savefig(saveBase+'/puSignificance.png',bbox_inches='tight')
