    ...
    for preReweight in [False]:
        ...
        for cands in candDict:
            ...
            for ky in ['ttX','ggJetsM80','gJets']:
                hist=histStore[ky]['cat0_m2jj'].Clone()
            ...
            ky='signal'
            histSig=histStore[ky]['cat0_m2jj'].Clone()
            ...
            iCol+=1
#    
            dataHist=histStore['data2018']['cat0_m2jj'].Clone()
            ...
            #canvas.SetLogy()
            #canvas.Draw()
            oFname=pltPrefix+'/cat0_m2jj_ratio.png'
            if preReweight:
                oFname=pltPrefix+'/cat0_m2jj_preReweighting_ratio.png'
