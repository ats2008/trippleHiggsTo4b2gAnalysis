...
class bdtScaler:
    ...
    def transform(self, x):
        ...
        return x
    def loadFromScaler( self, bdtScalerInstance  ):
        self.reweighter_base  = bdtScalerInstance.reweighter_base
        self.reweighter       = bdtScalerInstance.reweighter
        self.doTransformation = bdtScalerInstance.doTransformation
        self.classifier       = bdtScalerInstance.classifier 
        self.classifierInitialized = bdtScalerInstance.classifierInitialized 
        self.normalizationFactor = bdtScalerInstance.normalizationFactor 
