...
for fname in allFnames:
    ...
    for i in range(maxEvents_):
        ...
        allQuads=hhhSelector.getBJetParisFGG_MHA(eTree,etaMax,pTMin,mlScoreTag='H3SIN61',threshold=)
        if not allQuads['valid']:
            continue
        ...
        ntuple[cat+tag].Fill(array('f', skimmedDataDict.values()))
        histStore[cat+tag]['m1jj'].Fill(eTree.M1jj,wei)
        histStore[cat+tag]['m2jj'].Fill(eTree.M2jj,wei)
