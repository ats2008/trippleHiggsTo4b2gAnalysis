...
if __name__ == "__main__":
 ...
 #              'signal'         : 'results/nonReweited/signal_hhhTo4b2g.root',
        ...
        for cands in candDict:
            ...
            dataHist=histStore['data2018'][cands]['hgg']['mass'].Clone()
            ...
            #canvas.SetLogy()
            #canvas.Draw()
            oFname=pltPrefix+'/mass_gg_ratio.png'
            if preReweight:
                oFname=pltPrefix+'/mass_preReweighting_gg_ratio.png'
