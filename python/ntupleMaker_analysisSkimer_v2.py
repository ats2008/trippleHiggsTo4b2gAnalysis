...
for fname in allFnames:
    ...
    for i in range(maxEvents_):
        ...
        allQuads=hhhSelector.getBJetParisFGG_MHA(eTree,etaMax,pTMin,mlScoreTag='H3SIN61',threshold=mlScoreThreashold)
        ...
        cat='cat0'
        if tofill['r_HH'] < 40.0 :
            if quad['n_goodJets'] > 3.5:
                cat = 'cat1'
            elif quad['n_goodJets'] >2.5: 
                cat = 'cat2'
            else:
                cat ='cat5'
        else   : 
        ...
        histStore[cat+tag]['n_goodJets'].Fill( quad['n_goodJets'])
        #if tag!='':
